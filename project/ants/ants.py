...
class Bee(Insect):
    ...
    def blocked(self):
        ...
        "*** YOUR CODE HERE ***"
        return self.place.ant is not None and self.place.ant.blocks_path != False 
    ...
    def reduce_armor(self, amount):
        ...
        if self.armor - amount <= 0:
            ...
            for bee in bees:
                ...
                #Bee.reduce_armor(self.place.bees[index],self.damage)
        Ant.reduce_armor(self,amount)  # to kill the ant at last
...
class LongThrower(ThrowerAnt):
    ...
    def remote_place(self,distance):
        place = self.place
    ...
    def nearest_bee(self,hive):
        ...
        for i in range(self.min_range, self.max_range+1):
            place = self.remote_place(i)
            if place == None:
                break
            elif place != hive and place.bees != []:
                return random_or_none(place.bees)
        return None

class ShortThrower(LongThrower):
...
class ScubaThrower(ShortThrower):
    max_range = 6
    food_cost = 5
    name = 'Scuba'
    implemented = True
